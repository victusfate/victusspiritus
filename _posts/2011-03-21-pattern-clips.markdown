...
comments: []
---
<p><a href="http://www.clips.ua.ac.be/pages/pattern"><img src="{{ site.url }}/assets/2011/03/pattern_graph1.jpg" alt="" title="pattern_graph1" width="500" height="255" class="aligncenter size-full wp-image-8000" /></a><br />
...
<p><a href="http://rgl.rubyforge.org/rgl/index.html"><img src="{{ site.url }}/assets/2011/03/rgl_example.jpg" alt="" title="rgl_example" width="230" height="208" class="aligncenter size-full wp-image-8002" /></a><br />
...
<p>*=  The prominent semantic tagging tools have a nice free margin but you'll quickly run into problems if you want to process individual messages. I described the API costs and free levels in an <a href="http://victusfate.github.io/victusspiritus/uncategorized/2010/02/08/each-time-i-get-my-hands-dirty-i-learn/">earlier post</a>.</p>
<blockquote><p>
